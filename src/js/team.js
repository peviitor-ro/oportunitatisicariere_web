document.addEventListener('DOMContentLoaded', () => {
  ...
  function initializeTeams() {
    const desiredOrder = [
      "HR",
      "Scraping",      // Must match JSON ("Scraping", not "Scraper")
      "Back-end",
      "DevOps",
      "Front-end",
      "UI/UX",
      ...
      "QA",
      "Marketing",
      "Delivery",      // Will appear automatically once added to volunteers.json
      "Cybersecurity", // Added so it doesn't get pushed to the end randomly
      "Embed"
    ];
